  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium transition-smooth focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        ...
        hero: "gradient-hero text-primary-foreground shadow-glow hover:shadow-elevated border border-primary/20 hover:scale-105 transition-bounce",
        premium: "gradient-primary text-primary-foreground shadow-elegant hover:shadow-glow border border-primary-glow/30 hover:border-primary-glow/50",
        glass: "bg-surface/50 backdrop-blur-sm text-foreground border border-border/50 hover:bg-surface/80 shadow-card",
      },
      size: {
